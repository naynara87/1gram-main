    ...
    Slick = (function () {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button class="slick-prev btn btn-clear" aria-label="Previous" type="button" style="background-image:url(assets/media/1gram-img/btn/prev.svg) ;"></button>',
                nextArrow: '<button class="slick-next btn btn-clear" aria-label="Next" type="button" style="background-image:url(assets/media/1gram-img/btn/next.svg);"></button>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: '50px',
...
/******/ 	var __webpack_exports__ = __webpack_require__("../demo1/src/js/pages/slick.js");
/******/ 	
/******/ })()
;
